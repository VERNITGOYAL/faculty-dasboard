...
export default function MyGBUSidebar() {
  ...
  const menuItems = [
    ...
    { icon: User, label: 'faculty Profile', route: '/profile' },
    { icon: GraduationCap, label: 'my courses', route: '/academic', badge: '2' },
    { icon: FileText, label: 'Assignments', route: '/assignments', badge: '5' },
    { icon: BarChart3, label: 'Attendance', route: '/attendance' },
    { icon: ClipboardList, label: 'student feedback', route: '/feedback' },
    { icon: CreditCard, label: 'leave approval', route: '/leave', badge: '!' },
    { icon: BookOpen, label: 'messaging', route: '/message' },
    { icon: FlaskConical, label: 'grievance portal', route: '/portal' },
    { icon: Briefcase, label: 'E office', route: '/office', badge: 'NEW' },
    { icon: Heart, label: 'Wellness', route: '/wellness' },
    {icon: Users, label: 'Residence', route: '/residence',},
    { icon: Calendar, label: 'startup and innovation', route: 'startup' },
    { icon: MessageCircle, label: 'clubs', route: '/clubs', badge: '12' },
    { icon: Award, label: 'Social Impacts', route: '/impacts' },
     { icon: BellIcon, label: 'notifications', route: '/notification' },
  ];
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
           ...
           />
            ...
            {!isCollapsed && (
              <span className="text-x-2 font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                Faculty Dashboard
              </span>
            )}
          </div>
